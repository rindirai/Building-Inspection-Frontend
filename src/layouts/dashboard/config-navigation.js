    ...
    () => [
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          // USER
          {
            title: t('Projects Inspection '),
            path: paths.dashboard.user.root,
            icon: ICONS.user,
            children: [
              // { title: t('profile'), path: paths.dashboard.user.root },
              // { title: t('cards'), path: paths.dashboard.user.cards },
              { title: t('All Projects'), path: paths.dashboard.user.list },
              { title: t('Pending Projects'), path: paths.dashboard.user.list2 },
              { title: t('Active Projects'), path: paths.dashboard.user.list3 },
              { title: t('Passed Projects'), path: paths.dashboard.user.list4 },
              { title: t('Failed Projects'), path: paths.dashboard.user.list5 },
